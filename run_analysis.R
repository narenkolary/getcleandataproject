## Segment 1: Loading required packages
library(plyr)
library(dplyr)
library(reshape2)

## Segment 2: Reading in Samsung data from working directory
...
## Segment 3: Prepping the individual datasets
...
## Segment 4: Merging test and training data together with appropriate labels and activity names
...
## Segment 5: Extracting tidy data set with average of all variables for combinations of 
...
## Segment 6: Writing the final tidy dataset to a text file
